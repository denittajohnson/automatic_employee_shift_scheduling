...
elseif($i==2)
{
	echo "<input type='hidden' name='$name' value='$_SESSION[did]' class='form-control'  required>";
...
else
{
   ...
   if($type_only=="time" )
  {
	  ...
	  ".str_replace('_', ' ', $name)."</label><input type='time' name='$name'class='form-control' required> </div>
                                        </div>";
