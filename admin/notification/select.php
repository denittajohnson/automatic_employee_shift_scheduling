...
<th>Update</th>
 ...
 <th>Del</th> 
  ...
  // $i=0;
   ...
   {
	   $result=mysqli_query($con,"SELECT n.* FROM notification n JOIN employee e ON n.employee_id = e.id JOIN department d ON e.department = d.id WHERE d.cid ='$_SESSION[uid]'");
   }        
   else{
