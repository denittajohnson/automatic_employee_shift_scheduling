...
<th>Update</th>
 ...
 <th>Del</th> 
  ...
  // $i=0;
   ...
   {
	   $result=mysqli_query($con,"SELECT sr.* FROM shift_reassign srJOIN shift s ON sr.shift_id = s.id JOIN department d ON s.department_id = d.id WHERE d.cid= '$_SESSION[uid]'");
   }        
   else{
